import { alpha, PaletteColor, PaletteOptions, TypeAction } from '@mui/material/styles';

// https://mui.com/material-ui/customization/palette/ => for more information
...
export const action: Omit<
  TypeAction,
  'active' | 'selectedOpacity' | 'focusOpacity' | 'activatedOpacity'
> = {
